"""
Mask R-CNN
Train on the Tufts Dental dataset and implement teeth segmentation
...
ROOT_DIR = os.path.abspath("/content/drive/MyDrive/Projects/Tufts")
...
class HailDataset(utils.Dataset):
    ...
    def load_hail(self, dataset_dir, subset):
        ...
        self.add_class("RVG_teeth", 1, "teeth")
        ...
        # Changing the dict back to list as in VIA 2.0, regions was changed from a dict to a list.
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not teeth dataset, delegate to parent class.
        image_info = self.image_info[image_id]
        if image_info["source"] != "RVG_teeth":
        ...
        #class_ids = np.array([1 for i in range(201)])
